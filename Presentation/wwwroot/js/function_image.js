(function ($) {
    ...
    $.fn.inputFileText = function (userOptions) {
        ...
        var button = $(
            '<input type="button" value="' + options.text + '" class="btn btn-light border-' + options.buttonClass + '" />'
        ).insertAfter(this);
...
var getChooseFile = document.getElementById("choose-file");
var imageLabel = document.getElementById("choose-label");
getChooseFile.addEventListener("input", function () {
